 ...
 */
package com.woodys.eventcollect.receiver;
...
import com.woodys.eventcollect.collector.IntentManager;
...
public class TcScreenObserver extends BroadcastReceiver {
	...
	public void start() {
		try {
			...
			StatLog.w(LOG_TAG, "start Exception", e);
		}
	}
	...
	public void stop() {
		try {
			...
			StatLog.w(LOG_TAG, "stop Exception", e);
		}
	}
